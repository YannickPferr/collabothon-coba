    ...
    return (
      ...
      router.asPath !== "/chat" && (
        <div className={styles.footer}>
          ...
          <Link onClick={() => router.push("/donation")} underline="hover">
  ...
  return (
    router.asPath !== "/" && (
      <div className={styles.footer}>
        ...
        <Link onClick={() => router.push("/best-practices")} underline="hover">
          <Typography color={"white"}>Best Practices</Typography>
        </Link>
        <Link onClick={() => router.push("/privacy-policy")} underline="hover">
          <Typography color={"white"}>Privacy Policy</Typography>
        </Link>
        <Link
          onClick={() => router.push("/terms-and-conditions")}
